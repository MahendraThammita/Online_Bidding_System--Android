...
public class Fashion_category extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Size        =       findViewById(R.id.setCondition);
            ...
            public void savedata(){
                try {
                    if (TextUtils.isEmpty(Title.getText().toString()))
                        ...
                        Toast.makeText(getApplicationContext(), "Material is Required!", Toast.LENGTH_LONG).show();
                    else if (TextUtils.isEmpty(Size.getText().toString()))
                        Toast.makeText(getApplicationContext(), "Size is Required!", Toast.LENGTH_LONG).show();
